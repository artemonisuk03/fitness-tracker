...
class AdapterUsers(private val items: List<ActivityItem>, private val onItemClick: (Long) -> Unit) :
    ...
    class ActivityViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val timeAgoText: TextView = view.findViewById(R.id.time_ago_text)

        fun bind(item: ActivityItem.Activity, onItemClick: (Long) -> Unit) {
